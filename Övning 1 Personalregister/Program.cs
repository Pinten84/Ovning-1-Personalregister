                ...
                switch (choice)
                {
                    ...
                    case "2":
                        ...
                        else
                        {
                            ...
                            // Loopa genom listan och skriv ut anställda med index
                            for (int i = 0; i < employees.Count; i++)
                            {
                                Console.WriteLine("ID #" + i + ": Namn: " + employees[i].name + ", Lön: " + employees[i].salary + " kr");
                            }
                            Console.WriteLine("Ange ID (numret) på den anställde som ska tas bort: ");
